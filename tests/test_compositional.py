...
def test_reviewed_ako_cells():
 ...
 assert realize_ako(person=2,number="Sing")=="akago"
 assert realize_ako(person=2,number="Sing",mood="Ind")=="akagore"
 assert realize_ako(person=1,number="Plur",clusivity="In")=="pagago"
 assert realize_ako(person=1,number="Plur",clusivity="In",mood="Ind")=="pagagore"
...
def test_unlicensed_cells_are_not_invented():
 assert realize_ako(person=2,number="Plur",mood="Ind") is None
