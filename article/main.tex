...
The latter result demonstrates task preservation within the licensed v1 domain;
...
A natural next test is a challenge set containing unsupported and partially
reviewed requests. Such an experiment would evaluate abstention and blocking
directly, complementing the present licensed-domain study.
