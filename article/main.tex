...
delegated to reviewed grammar; and (iii) whether the evidence-bounded system
must block any of those proposals because a required license is absent. In the
frozen v1 sample, all 28 proposals preserve the requested specification and all
28 are realizable, so the third outcome is observed as zero blocked proposals
for this particular reviewed task set. This does not imply that blocking would
remain zero outside the frozen licensed inventory.
